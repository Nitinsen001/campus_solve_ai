...
Push the project to GitHub and import it at Vercel with the **Root Directory** set to `campus_solve_ai` (the folder containing `requirements.txt` and `vercel.json`). Vercel detects Django automatically.
